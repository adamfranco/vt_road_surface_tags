	...
	def ways_callback(self, ways):
		...
		for osmid, tags, refs in ways:
			...
			if 'highway' in tags and tags['highway'] in self.roads:
				...
				if 'tiger:name_base' in tags:
					way['tiger:name_base'] = tags['tiger:name_base']
				else:
					way['tiger:name_base'] = ''
				
				if 'tiger:name_type' in tags:
					way['tiger:name_type'] = tags['tiger:name_type']
				else:
					way['tiger:name_type'] = ''
